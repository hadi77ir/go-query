...
> **🤖 AI-Generated Code**: This entire library was generated by AI (Claude Sonnet 4.5 and Cursor Auto) as a collaborative programming exercise. While comprehensive testing has been included, please review and test thoroughly before using in production environments.

## ✨ Key Features

- **🔍 Google-like Search**: Type bare words and they'll be searched automatically
- **🎯 GORM-style API**: Pass a pointer to your result slice, just like GORM
- **📦 CBOR Cursors**: 50% smaller than JSON, faster encoding
...
- **📊 Smart Parentheses**: Full support for complex nested expressions
...
├── parser/                   # Query parser with cache
├── query/                    # Core types  
├── executor/                 # Interface
